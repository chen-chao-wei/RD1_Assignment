...
CREATE TABLE obsrain (id int NOT NULL PRIMARY KEY AUTO_INCREMENT,locationName varchar(50),obsStationName varchar(50),obsTime datetime ,HOUR_24 varchar(30),NOW varchar(30));