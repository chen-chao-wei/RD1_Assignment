        ...
        function getWeather(city) { 
            ...
            $.ajax({
                ...
                success: function(Jdata) {
                    ...
                    //     $("#showCard").append('</div>');                        
                    // };
                    $('#card1 h3').text("今日白天"); $("#card1 #Wx").text(day[0]); $("#card1 #T").text("攝氏溫度"+day[2]+"~"+day[4]+"°C"); $("#card1 #POP").text("降雨機率 "+day[1]+"%"); $("#card1 #CI").text(day[3]);
                    $('#card2 h3').text("今日白天"); $("#card2 #Wx").text(night[0]); $("#card2 #T").text("攝氏溫度"+night[2]+"~"+night[4]+"°C"); $("#card2 #POP").text("降雨機率 "+night[1]+"%"); $("#card2 #CI").text(night[3]);
                    $('#card3 h3').text("今日白天"); $("#card3 #Wx").text(tomorrow[0]); $("#card3 #T").text("攝氏溫度"+tomorrow[2]+"~"+tomorrow[4]+"°C"); $("#card3 #POP").text("降雨機率 "+tomorrow[1]+"%"); $("#card3 #CI").text(tomorrow[3]);
                },                
                error: function() {
                    alert("ERROR!!!");
                }
